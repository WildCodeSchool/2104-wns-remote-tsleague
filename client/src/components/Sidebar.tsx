...
export class DrawerExample extends React.PureComponent<
...
> {
  ...
  private handleAutoFocusChange = handleBooleanChange((autoFocus) =>
  ...
  private handleUsePortalChange = handleBooleanChange((usePortal) =>
    this.setState({ usePortal })
  );

  private handlePositionChange = handleValueChange((position: Position) =>
  ...
  private handleSizeChange = handleStringChange((size) =>
    this.setState({ size })
  );
        ...
        >
          <div className={Classes.DRAWER_BODY}>
            <div className={Classes.DIALOG_BODY}>
              <p>
                <strong>
                  Data integration is the seminal problem of the digital age.
                  For over ten years, we’ve helped the world’s premier
                  organizations rise to the challenge.
                </strong>
              </p>
              <p>
                Palantir Foundry radically reimagines the way enterprises
                interact with data by amplifying and extending the power of data
                integration. With Foundry, anyone can source, fuse, and
                transform data into any shape they desire. Business analysts
                become data engineers — and leaders in their organization’s data
                revolution.
              </p>
              <p>
              ...
              <p>
                ...
                Access controls, transformation logic, and data quality flow
                from original data source to intermediate analysis to
                presentation in real time. Every end product created in Foundry
                becomes a new data source that other users can build upon. And
                the enterprise data foundation goes where the business drives
                it.
              </p>
              <p>
